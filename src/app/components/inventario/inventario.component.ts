...
export class InventarioComponent implements OnInit {
  productos: Producto[] = [];
  nuevoProducto: Producto = new Producto(0, '', undefined, '');  
  productoSeleccionado: Producto = new Producto(0, '', undefined, '');  
  ...
  agregarProducto(): void {
    ...
    this.nuevoProducto.precio = Number(this.nuevoProducto.precio);  
    this.inventarioService.agregarProducto(this.nuevoProducto);
    this.cargarImagenes(); 
    this.nuevoProducto = new Producto(0, '', undefined, '');  
  ...
  abrirModal(producto: Producto, index: number): void {
    ...
    this.productoSeleccionado.precio = Number(this.productoSeleccionado.precio);  
